      ...
      <main className="flex-1">
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl bg-white dark:bg-gray-800">
                  <div className="p-6">
                    <div className="flex justify-between items-center mb-6">
                      <h3 className="font-semibold text-lg">個人碳足跡儀表板</h3>
                      <span className="text-green-600 dark:text-green-400 font-medium">演示</span>
                    </div>
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                          <p className="text-sm text-gray-500 dark:text-gray-400">本月排放</p>
                          <p className="text-2xl font-bold">124 kg</p>
                          <p className="text-xs text-red-500">+12% ↑</p>
                        </div>
                        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                          <p className="text-sm text-gray-500 dark:text-gray-400">已抵消</p>
                      ...
                      <div className="bg-green-50 dark:bg-green-900/30 p-3 rounded-lg">
                        <p className="text-sm text-green-700 dark:text-green-400">您的碳足跡低於社區平均水平 15%</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="space-y-8">
                  <div className="flex gap-4">
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-green-100 dark:bg-green-900/50 flex items-center justify-center text-green-600 dark:text-green-400 font-bold">1</div>
                    <div>
                      <h3 className="text-xl font-medium mb-2">計算您的碳足跡</h3>
                      <p className="text-gray-600 dark:text-gray-400">
                  ...
                  <div className="flex gap-4">
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-green-100 dark:bg-green-900/50 flex items-center justify-center text-green-600 dark:text-green-400 font-bold">2</div>
                    <div>
                      <h3 className="text-xl font-medium mb-2">瞭解您的碳足跡來源</h3>
                      <p className="text-gray-600 dark:text-gray-400">
                  ...
                  <div className="flex gap-4">
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-green-100 dark:bg-green-900/50 flex items-center justify-center text-green-600 dark:text-green-400 font-bold">3</div>
                    <div>
                      <h3 className="text-xl font-medium mb-2">抵消您無法減少的碳排放</h3>
                      <p className="text-gray-600 dark:text-gray-400">
        ...
        <section className="py-20 bg-gradient-to-br from-green-600 to-blue-600 text-white">
          <div className="container mx-auto px-4 md:px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">準備好為環境保護做出貢獻了嗎？</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/about">
                <Button variant="outline" size="lg" className="text-white border-white hover:bg-green-700/20">
                  了解更多
                </Button>
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/market" className="text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400">
                    交易市場
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/trade-history" className="text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400">
                    交易歷史
                  </Link>
                </li>
              </ul>
